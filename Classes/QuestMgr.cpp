...
{
	Result _result;
	if (sDataMgr->selectUnitDataList("SELECT id,title,quest_text,require_level,requre_rep_id,require_rep_count,quest_require_type_1,quest_require_id_1,quest_require_count_1,quest_require_type_2,quest_require_id_2,quest_require_count_2,quest_require_type_3,quest_require_id_3,quest_require_count_3,quest_require_type_4,quest_require_id_4,quest_require_count_4,quest_reward_money,quest_reward_exp,quest_reward_cash,quest_reward_type_1,quest_reward_id_1,quest_reward_count_1,quest_reward_type_2,quest_reward_id_2,quest_reward_count_2,quest_reward_type_3,quest_reward_id_3,quest_reward_count_3,quest_reward_type_4,quest_reward_id_4,quest_reward_count_4 FROM quest_template", _result))
	{
		if (_result.empty())
		{
